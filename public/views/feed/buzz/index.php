    ...
    <div class="layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
        ...
        <div class="drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50" id="side-bar-nav">
            ...
            <nav class="navigation mdl-navigation mdl-color--white-grey-800">
                <a class="mdl-navigation__link" href="index.php"><i class="material-icons">notifications_active</i>Academics</a>              
            </nav>
            <nav class="navigation mdl-navigation mdl-color--white-grey-800">
                <a class="mdl-navigation__link" href="index.php"><i class="material-icons">notifications_active</i>Electronics</a>              
            </nav>
            <nav class="navigation mdl-navigation mdl-color--white-grey-800">
